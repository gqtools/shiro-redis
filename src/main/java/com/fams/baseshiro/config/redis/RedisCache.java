...
public class RedisCache<K, V> implements Cache<K, V> {
    ...
    private String getRedisKeyFromPrincipalIdField(PrincipalCollection key) {
        ...
        for (Method m:methods) {
            ...
            boolean result = RedisCacheManager.DEFAULT_PRINCIPAL_ID_FIELD_NAME.equals(this.principalIdFieldName) && ("getAuthCacheKey".equals(m.getName()) || "getUserCode".equals(m.getName()));
            if (result) {
                pincipalIdGetter = m;
                break;
            }
